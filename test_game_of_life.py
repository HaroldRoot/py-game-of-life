from game_of_life import next_board_state, MOORE_NEIGHBORHOOD
...
def test_next_board_state():
    ...
    actual_next_state1 = next_board_state(init_state1, MOORE_NEIGHBORHOOD)
    ...
    actual_next_state2 = next_board_state(init_state2, MOORE_NEIGHBORHOOD)
    ...
    actual_next_state3 = next_board_state(init_state3, MOORE_NEIGHBORHOOD)
    ...
    actual_next_state4 = next_board_state(init_state4, MOORE_NEIGHBORHOOD)
    ...
    actual_next_state5 = next_board_state(init_state5, MOORE_NEIGHBORHOOD)
